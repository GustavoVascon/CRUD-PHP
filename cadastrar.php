    ...
    <form method="POST">
        ...
        <div class="input-group">
            ...
            <input <?php if (isset($usuario->erro["erro_nome"]) or isset($erro_geral)) {
                    ...
                    } ?> name="nome" type="text" <?php if (isset($_POST['nome'])) {
                                                        echo 'value="' . $_POST['nome'] . '"';
                                                    } ?> placeholder="Nome Completo" required>
            <div class="erro"><?php if (isset($usuario->erro["erro_nome"])) {
        ...
        <div class="input-group">
            ...
            <div class="erro"><?php if (isset($usuario->erro["erro_email"])) {
        ...
        <div class="input-group">
            ...
            <input <?php if (isset($usuario->erro["erro_senha"]) or isset($erro_geral)) {
                        echo  'class="erro-input"';
                    } ?> type="password" name="senha" <?php if (isset($_POST['senha'])) {
                                                            echo 'value="' . $_POST['senha'] . '"';
                                                        } ?> placeholder="Senha mínimo 6 Dígitos" required>
            <div class="erro"><?php if (isset($usuario->erro["erro_senha"])) {
        ...
        <div class="input-group">
            ...
            <input <?php if (isset($usuario->erro["erro_repete"]) or isset($erro_geral)) {
                        echo  'class="erro-input"';
                    } ?> type="password" name="repete_senha" <?php if (isset($_POST['repete_senha'])) {
                                                                    echo 'value="' . $_POST['repete_senha'] . '"';
                                                                } ?> placeholder="Repita a senha criada" required>
            <div class="erro"><?php if (isset($usuario->erro["erro_repete"])) {
                                    echo $usuario->erro["erro_repete"];
                                } ?></div>
        </div>

        <div <?php if (isset($erro_geral) && $erro_geral == "Todos os campos são obrigatórios!") {
